...
use crate::pages::home::access::screen_share_requests::ScreenShareRequests;
...
pub enum Route {
    ...
    OutgoingRequests,
    #[at("/access/screen-share-requests")]
    ScreenShareRequests,
    #[at("/canvas/:id")]
    Canvas { id: String },
    #[not_found]
...
pub fn switch(routes: Route, dark_mode: bool, toggle_theme: Callback<()>) -> Html {
    match routes {
        ...
        Route::ConnectedUsers => {
            html! { <ConnectedUsers dark_mode={dark_mode} toggle_theme={toggle_theme} /> }
        }
        Route::Viewers => html! { <Viewers dark_mode={dark_mode} toggle_theme={toggle_theme} /> },
        Route::IncomingRequests => {
            html! { <IncomingRequests dark_mode={dark_mode} toggle_theme={toggle_theme} /> }
        }
        Route::OutgoingRequests => {
            html! { <OutgoingRequests dark_mode={dark_mode} toggle_theme={toggle_theme} /> }
        }
        Route::ScreenShareRequests => {
            html! { <ScreenShareRequests dark_mode={dark_mode} toggle_theme={toggle_theme} /> }
        }
        Route::Canvas { id } => {
            html! { <CanvasPage id={id} dark_mode={dark_mode} toggle_theme={toggle_theme} /> }
        }
